...
See also: [Formal Verification (Security Models)](/security/formal-verification), [Provenance-aware enforcement metadata](/security/provenance-enforcement-metadata), [Provenance-aware tool enforcement](/security/provenance-tool-enforcement), and [Tool classification metadata](/security/tool-classification-metadata)
